...
plt.plot(Yjreal,"y", markersize=1)
plt.plot(Yjimag,"y", markersize=1)

plt.plot(Zjreal,"y", markersize=1)
plt.plot(Zjimag,"y", markersize=1)

plt.plot([Yn*50, (50)],"b", label="r = 0.7",markersize=1)
plt.plot([Zn*50, (50)],"b", label="r = 0.7",markersize=1)
plt.plot(50)

plt.plot(Yn*50,"g",label="Admittanz")
